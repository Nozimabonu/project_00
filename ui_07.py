...
def delete_todo():
    id = input('Todo id: ')
    response: ResponseData = service.delete_todo(id)
    print_response(response)
    print(response.data)

def edit_todo():
    name = input('Todo name: ')
    message = input('Todo message: ')
    response: ResponseData = service.edit_todo(name, message)
    print_response(response)
    print(response.data)

def view_todo():
    active = input('Todo active: ')
    response: ResponseData = service.view_todo(active)
    print_response(response)
    print(response.data)
